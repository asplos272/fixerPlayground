...
theory  FixInvalidStoreFilled imports  BaseProof1.BasicInvariants  begin
...
by presburger
have i202: "snps2 T = []" by (metis i1x i613old)
...
by presburger
have aux_r110: "dthdatas1 T = dthdatas1 ( T [ 0 +=rdreq RdOwn] [ 0 s= IMAD])" by simp
have aux_r140: "nextLoad ( T [ 0 +=rdreq RdOwn] [ 0 s= IMAD]) 1 = nextLoad T 1" by simp
show ?thesis
