...
theory  FixSharedLoadFilled imports  BaseProof1.BasicInvariants  begin
...
by presburger
have i203: "\<not>CSTATE Modified T 1" by (metis assms i462)
have i204: "\<not>CSTATE Modified  (T [ -=i 0]) 1"
using i201 i203
by blast
have i205: "CSTATE Shared (T [ -=i 0]) 0" by (metis i1x i201)
have i206: "\<not>(CSTATE Invalid T 1 \<and> nextStore T 1 \<and> HSTATE SAD T)" by (metis CSTATE_different1 CSTATE_different2 MESI_State.distinct(101) MESI_State.distinct(143) i106 i1x)
...
have aux_r93_2: "\<not>CSTATE MIA (T [ -=i 0]) 0" by (smt (verit) CSTATE_disj4' MESI_State.distinct(117) MESI_State.distinct(133) i205)
