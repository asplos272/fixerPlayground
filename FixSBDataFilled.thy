...
theory  FixSBDataFilled imports  BaseProof1.BasicInvariants  begin
...
by blast
have i213: "  ( snps2 ( T [ 5 sHost= SharedM] [ Dev1 -=d2hdHead ]) ) = snps2 T" by simp
have i214: " snpresps2 ( T [ 5 sHost= SharedM] [ Dev1 -=d2hdHead ]) = snpresps2 T "
using snpresps2_HostSBData
by blast
have i2150: "htddatas1 T = htddatas1 ( T [ 5 sHost= SharedM] [ Dev1 -=d2hdHead ])" by simp
...
using i225 i35
by force
have aux346: " \<not> (CSTATE IMAD T 1 \<and> nextGOPending T 1)" by (smt (verit) CSTATE_different2 HOST_State.distinct(121) HOST_State.distinct(305) HSTATE_invariant3 MESI_State.distinct(261) i160 i189 i1x i225 i2x i346 i348 i432 i455 i887 i910 reqresps_empty_noGOPending2)
