...
theory  FixIBDataFilled imports BaseProof1.BasicInvariants  begin
...
by blast
have i213: "  ( snps2 ( T [ 5 sHost= InvalidM] [ Dev1 -=d2hdHead ]) ) = snps2 T" by simp
have i214: " snpresps2 ( T [ 5 sHost= InvalidM] [ Dev1 -=d2hdHead ]) = snpresps2 T "
using snpresps2_HostIBDataPrevious
by blast
have i2150: "htddatas1 T = htddatas1 ( T [ 5 sHost= InvalidM] [ Dev1 -=d2hdHead ])" by simp
...
using i225 i35
by force
have aux346: " \<not> (CSTATE IMAD T 1 \<and> nextGOPending T 1)" by (metis CSTATE_different2 MESI_State.distinct(147) assms)
have aux408: "reqresps1 T = []" by (metis i1x i2x i721)
