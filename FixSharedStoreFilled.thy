...
theory  FixSharedStoreFilled imports  BaseProof1.BasicInvariants  begin
...
by blast
have aux_r110: "dthdatas1 T = dthdatas1 ( T [ 0 +=rdreq RdOwn] [ 0 s= SMAD])" by simp
have aux_r140: "nextLoad ( T [ 0 +=rdreq RdOwn] [ 0 s= SMAD]) 1 = nextLoad T 1" by simp
