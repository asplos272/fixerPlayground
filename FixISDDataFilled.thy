...
theory  FixISDDataFilled imports  BaseProof1.BasicInvariants  begin
...
using i74 i1x
by blast
have i221: " CSTATE Shared ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) 0" by (metis CSTATE_assign_rule_6)
have i222: "nextLoad T 0" by (metis assms i751old)
...
have aux_not_invalidM: " \<not> HSTATE InvalidM T" by (metis i2x i672)
...
have aux53p: "\<not> nextHTDDataPending ( T [ 0 s= Shared] [ 0 :=dd msg] [ -=i 0] [ 0 -=devd ]) 0" by (metis HTDDataPending_htddatas_invariant1 aux53)
show ?thesis
