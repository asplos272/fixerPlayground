...
theory    FixMDDataFilled  imports BaseProof1.BasicInvariants  begin
...
have i1x: "HSTATE MD T " by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
...
\<close>
have i2131: "htddatas2 T = []" by (smt (verit) HOST_State.distinct(251) HOST_State.distinct(269) HSTATE_invariant3 i164 i183 i189 i1x i2x i367 i424 i454 nextDTHDataFrom_def nextHTDDataPending_def zero_neq_one)
have i2130: "length (htddatas2 (T [ Dev2 +=h2dd hmsg]  )) \<le> 1"
using HostMDData_htddatas2_aux i2131
by blast
have i213: "  ( snps2 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= ModifiedM] [ Dev1 -=d2hdHead ]) ) = snps2 T" by simp
have i214: " snpresps2 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= ModifiedM] [ Dev1 -=d2hdHead ]) = snpresps2 T "
using snpresps2_HostMDData
by blast
have i2150: "htddatas1 T = htddatas1 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= ModifiedM] [ Dev1 -=d2hdHead ])" by simp
...
using i110
by blast
have i220: " (reqresps1 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= ModifiedM] [ Dev1 -=d2hdHead ])) = reqresps1 T " by simp
have i225: "\<not>CSTATE  Invalid T 1" by (meson assms i154 i193 nextDTHDataFrom_def)
