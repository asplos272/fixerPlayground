...
theory  FixSharedEvictFilled imports  BaseProof1.BasicInvariants  begin
...
by blast
have aux_r110: "dthdatas1 T = dthdatas1 ( T [ 0 +=rdreq CleanEvictNoData] [ 0 s= SIA])" by simp
have aux_r140: "nextLoad ( T [ 0 +=rdreq CleanEvictNoData] [ 0 s= SIA]) 1 = nextLoad T 1" by simp
show ?thesis
