...
theory  FixSDDataFilled imports  BaseProof1.BasicInvariants  begin
...
have i1x: "HSTATE SD T " by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
...
using i57
by fastforce
have i210: " (reqresps1 T ) = []" by (smt (verit) i1x i2x i964)
have i211: "(snps2 T ) = []" by (smt (verit) i168 i1x i2x i962)
have i212: "snpresps2 T = []" by (smt (verit) i136 i1x i2x nextDTHDataFrom_def)
...
by blast
have i213: "  ( snps2 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= SharedM] [ Dev1 -=d2hdHead ]) ) = snps2 T" by simp
have i214: " snpresps2 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= SharedM] [ Dev1 -=d2hdHead ]) = snpresps2 T "
using snpresps2_HostSDData
by blast
have i2150: "htddatas1 T = htddatas1 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= SharedM] [ Dev1 -=d2hdHead ])" by simp
...
using i110
by blast
have i220: " (reqresps1 ( T [ Dev2 +=h2dd hmsg] [ =hv v] [ 5 sHost= SharedM] [ Dev1 -=d2hdHead ])) = reqresps1 T " by simp
