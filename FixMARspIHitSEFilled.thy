...
theory  FixMARspIHitSEFilled imports  BaseProof1.BasicInvariants  begin
...
have i2x: "nextSnpRespIs RspIHitSE T 0" by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
have i00x: "GTS T 0" by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
have i3x: "htddatas1 T = []" by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
...
by blast
have i238: "htddatas1 ( T [ 1 +=reqresp GO Modified txid] [ 5 sHost= ModifiedM] [ 0 -=snpresp  ]) = [] \<or> CSTATE ISDI ( T [ 1 +=reqresp GO Modified txid] [ 5 sHost= ModifiedM] [ 0 -=snpresp  ]) 0" by (metis CSTATE_HostMARspIHitSE_otherside_invariant3 i2150 i237)
...
have aux404b2: "\<not> nextHTDDataPending ( T [ 1 +=reqresp GO Modified txid] [ 5 sHost= ModifiedM] [ 0 -=snpresp  ]) 0 \<or> CSTATE ISDI ( T [ 1 +=reqresp GO Modified txid] [ 5 sHost= ModifiedM] [ 0 -=snpresp  ]) 0" by (metis HTDDataPending_htddatas_invariant1 HostMARspIHitSE_nextHTDDataPending_real i2150 i238)
