...
theory  FixModifiedEvictFilled imports  BaseProof1.BasicInvariants  begin
...
have i201: "reqs1 T = []" by (smt (verit) i1x i487)
have i202: "snps2 T = []" by (smt (verit) i1x i489)
have i203: "length (reqs1 ( T [ 0 +=rdreq DirtyEvict] [ 0 s= MIA])) \<le> 1"
using i201 reqs1_ModifiedEvict
by presburger
have i204: "snps2 T = [] \<and> snpresps2 T = [] \<and> reqresps1 T = [] \<and> htddatas1 T = []" by (smt (verit) i1x i202 i489)
...
by blast
have aux_r110: "dthdatas1 T = dthdatas1 ( T [ 0 +=rdreq DirtyEvict] [ 0 s= MIA])" by simp
have aux_r140: "nextLoad ( T [ 0 +=rdreq DirtyEvict] [ 0 s= MIA]) 1 = nextLoad T 1" by simp
show ?thesis
