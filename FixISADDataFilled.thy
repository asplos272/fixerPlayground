...
theory  FixISADDataFilled imports  BaseProof1.BasicInvariants  begin
...
by blast
have aux2_i300: "CSTATE ISA (T [ 0 s= ISA] [ 0 :=dd msg] [ 0 -=devd ]) 0 =  CSTATE ISA (T [ 0 s= ISA]) 0" by simp
...
have aux107: "\<not> HSTATE ModifiedM T" by (metis HOST_State.distinct(11) HOST_State.distinct(17) HOST_State.distinct(3) HOST_State.distinct(33) HOST_State.distinct(35) HSTATE_invariant4 i201)
...
by presburger
have intermediate105: "snpresps1 T = []" by (metis assms i2x i731)
show ?thesis
