...
theory  FixSARspIFwdMFilled imports  BaseProof1.BasicInvariants  begin
...
have i2010: "CSTATE Invalid (  T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SharedM] [ 0 -=snpresp  ]) 0 \<or> CSTATE ISDI (  T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SharedM] [ 0 -=snpresp  ]) 0 \<or> CSTATE ISAD (  T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SharedM] [ 0 -=snpresp  ]) 0 \<or> CSTATE IMAD (  T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SharedM] [ 0 -=snpresp  ]) 0 \<or> CSTATE IIA (  T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SharedM] [ 0 -=snpresp  ]) 0" by (smt (verit) CSTATE_HostSARspIFwdM_otherside_invariant3 assms i460)
...
by presburger
have i228: "\<not>CSTATE Modified (  T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SharedM] [ 0 -=snpresp  ]) 0" by (metis CSTATE_disj1 MESI_State.distinct(11) MESI_State.distinct(13) MESI_State.distinct(15) MESI_State.distinct(31) MESI_State.distinct(5) i2010)
have i229aux: " \<not> CSTATE MIA T 0" by (smt (verit) CSTATE_different1 Invalid_not_eq_MIA MESI_State.distinct(273) MESI_State.distinct(307) MESI_State.distinct(339) MESI_State.distinct(493) i2x i460)
have i229: "\<not>CSTATE MIA (  T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SharedM] [ 0 -=snpresp  ]) 0" by (smt (verit) CSTATE_HostSARspIFwdM_otherside_invariant3 i229aux)
...
have g194aux: "\<not> nextGOPendingIs GO_WritePull T 0 \<and> \<not> nextGOPendingIs GO_WritePull T 1" by (metis i1x i799)
show ?thesis
