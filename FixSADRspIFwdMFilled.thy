...
theory  FixSADRspIFwdMFilled imports  BaseProof1.BasicInvariants  begin
...
by presburger
have i228: "\<not>CSTATE Modified ( T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SD] [ 0 -=snpresp  ]) 0" by (smt (verit) CSTATE_HostSADRspIFwdM_otherside_invariant3 CSTATE_disj1 MESI_State.distinct(11) MESI_State.distinct(13) MESI_State.distinct(15) MESI_State.distinct(31) MESI_State.distinct(5) assms i459)
...
using i234
by auto
have i236: "\<not> CSTATE IMAD ( T [ 1 +=reqresp GO Shared txid] [ 5 sHost= SD] [ 0 -=snpresp  ]) 1" by (smt (verit) CSTATE_inequality_invariant MESI_State.distinct(225) MESI_State.distinct(261) i226)
...
have i241: "CSTATE Invalid T 0 \<or> CSTATE ISDI T 0 \<or> CSTATE IMAD T 0 \<or> CSTATE ISAD T 0 \<or> CSTATE IIA T 0" by (smt (verit) i2x i459)
